...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">Panpharmacon</a>
    </div>
    <ul class="nav navbar-nav">
      <li class="active"><a href="#">Home</a></li>
      <li><a href="location.php">Show Location</a></li>
	  	<li><a href = "https://bladebreakers.000webhostapp.com/docs/QR.html" onclick="increase()">Give Attendance</a><li><br/><br/><br/>
...
// Create connection
				...
				$username = $_POST['name'];
				$sql = "UPDATE user_info SET Attendance=1 WHERE Username = '$username'";
...
<br/>
<br/>
<img id = "left_pic" height="100px" src = "left.jpg"/>
<img id = "right_pic" height="100px" src = "right.jpg"/>
</html>
